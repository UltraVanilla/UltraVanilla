...
public class SeenCommand extends UltraCommand implements CommandExecutor, TabExecutor {
    ...
    private void sendPromotionInfo(CommandSender sender, OfflinePlayer player, TimeZone timeZone) {
        plugin.async(() -> {
            sender.sendMessage(COLOR + "Last promoted: " + Palette.OBJECT + getDate(UltraVanilla.getPlayerConfig(player).getLong("last-promotion"), timeZone));
    ...
    private void sendLocationInfo(CommandSender sender, OfflinePlayer player) {
        Position position = (Position) UltraVanilla.getPlayerConfig(player).get(Users.LOGOUT_LOCATION);
        if (position != null) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (sender instanceof Player) {
            ...
            String zone = UltraVanilla.getPlayerConfig(player.getUniqueId()).getString("timezone");
